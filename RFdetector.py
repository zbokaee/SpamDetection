...
mobList = "0123456789"
urlList = [".com", ".in", ".org", ".ir"]
emojiList = [":)",":(",":P",":-*","XD", ":-|"]
keywordList = ["migration","money","call","offer","visa"]
specialSymList = "!@#$%^&*(){}[]:;\"'"
mathSymList = "+-/*%^."
...
def checkEmoji(msg):
    #To calculate the percentage of Emoji
    global emoji
    for i in emojiList:
        if i in msg:
            emoji += 1
...
def checkKeyword(msg):
    #To calculate the percentage of some keywords
    global keyword
...
def checkSpecialSym(msg):
    # To calculate the percentage of Specific Symbols
    global specialSym
    for i in msg:
